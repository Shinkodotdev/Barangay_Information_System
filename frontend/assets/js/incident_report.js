...
document.addEventListener('click', function () { document.querySelectorAll('[id^="dropdown-"]').forEach(d => d.classList.add('hidden')); });
...
document.addEventListener('change', e => {
    if (e.target.id === 'incidentCategory') {
...
function addAnotherPersonV2() {
    ...
    clone.querySelectorAll(".resident-field, .non-resident-field").forEach(el => {

    ...
    if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'Resident') {
        header('Location: ../../../index.php?error=Please log in as resident');
        exit();
    }
